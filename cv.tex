...
Project: Contributed to VMKit, the Systems Group's virtual machine monitor,
adding modern x86 processor support. \\
...
\section{SKILLS}
\par
RDMA (RoCEv2), DPU, SPDK, NVMe-oF, NVMe/TCP, Linux kernel, QEMU/KVM, Xen, \\
C, C++, Python, performance analysis and benchmarking (MLPerf), \\
